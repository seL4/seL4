...
if(KernelPlatformQEMUArmVirt)
  ...
  if(NOT DEFINED QEMU_DTS)
    ...
    if(NOT DEFINED QEMU_DTB)
      ...
      if(NOT QEMU_BINARY)
        ...
        execute_process(COMMAND ${QEMU_BINARY} -version RESULT_VARIABLE error
                        OUTPUT_STRIP_TRAILING_WHITESPACE OUTPUT_VARIABLE QEMU_STDOUT_MESSAGE)
        if(error)
      ...
      # unnecessarily.
      execute_process(COMMAND ${QEMU_CMD} RESULT_VARIABLE error ERROR_STRIP_TRAILING_WHITESPACE
    ...
    execute_process(COMMAND dtc -q -I dtb -O dts "${QEMU_DTB}" OUTPUT_VARIABLE QEMU_DTS_DATA
    ...
    if(QEMU_CMD)
      ...
      string(REPLACE ";" "\n *    " QEMU_DTS_INFO "DTS of QEMU v${QEMU_VERSION} for:;${QEMU_CMD}")
    endif()
    file(WRITE "${QEMU_DTS}" "/*\n" " * ${QEMU_DTS_INFO}\n" " */\n" "\n" "${QEMU_DTS_DATA}")
  ...
  declare_default_headers(
    TIMER_FREQUENCY 62500000 MAX_IRQ 159 NUM_PPI 32 TIMER drivers/timer/arm_generic.h
    INTERRUPT_CONTROLLER ${GicHeader} CLK_MAGIC 4611686019llu CLK_SHIFT 58u KERNEL_WCET 10u)
...
add_sources(DEP "KernelPlatformQEMUArmVirt" CFILES ${GicSource} src/arch/arm/machine/l2c_nop.c)

config_string(KernelUserTop USER_TOP "Set seL4_UserTop constant" DEFAULT ${qemu_user_top} UNQUOTE
