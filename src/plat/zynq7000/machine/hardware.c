...
const p_region_t BOOT_RODATA dev_p_regs[] = {
    ...
    { /* .start = */ CORESIGHT_PADDR   , /* .end = */ CORESIGHT_PADDR    + (  1 << 12)},
    { /* .start = */ TLICFG_GPV_PADDR  , /* .end = */ TLICFG_GPV_PADDR   + (  1 << 20)},
...
//  { /* .start = */ L2CC_PL310_PADDR  , /* .end = */ L2CC_PL310_PADDR   + (  1 << 12)},
    ...
    /* Programmable logic */
    { /* .start = */ PL_M_AXI_GP0_PADDR, /* .end = */ PL_M_AXI_GP0_PADDR + (  1 << 12)}, /* 80000000 */
    { /* .start = */ PL_M_AXI_GP1_PADDR, /* .end = */ PL_M_AXI_GP1_PADDR + (  1 << 12)}, /* C0000000 */
};
