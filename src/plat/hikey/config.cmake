...
if(KernelPlatformHikey)
    ...
    if(NOT DEFINED KernelDebugDisablePrefetchers)
        # This is a specific case for the hikey. KernelDebugDisablePrefetchers
        # is set in seL4/config.cmake, and will be set after the platform specific
        # configs are evaluated. This is explicitly setting this to off, as if
        # the user hasn't passed this config when building, it would have defaulted
        # to off for this platform anyways.

        set(KernelDebugDisablePrefetchers OFF INTERNAL)
    endif()
    config_string(
