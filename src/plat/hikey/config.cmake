...
if(KernelPlatformHikey)
  ...
  declare_default_headers(
    TIMER_FREQUENCY 1200000 MAX_IRQ 159 TIMER drivers/timer/arm_generic.h
    INTERRUPT_CONTROLLER arch/machine/gic_v2.h CLK_MAGIC 458129845llu CLK_SHIFT 39u KERNEL_WCET 10u)
endif()

config_string(
  KernelArmHikeyOutstandingPrefetchers
...
config_string(
  KernelArmHikeyPrefetcherStride
...
config_string(
  KernelArmHikeyPrefetcherNPFSTRM
...
config_option(
  KernelArmHikeyPrefetcherSTBPFRS
...
add_sources(DEP "KernelPlatformHikey" CFILES src/arch/arm/machine/gic_v2.c
