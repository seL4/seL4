...
void vcpu_sysvmenter_reply_to_user(tcb_t *tcb)
{
    ...
    setMR(tcb, buffer, SEL4_VMENTER_CALL_INTERRUPT_INFO_MR, vmread(VMX_CONTROL_ENTRY_INTERRUPTION_INFO));
...
static void setMRs_vmexit(uint32_t reason, word_t qualification)
{
    ...
    setMR(NODE_STATE(ksCurThread), buffer, SEL4_VMENTER_CALL_INTERRUPT_INFO_MR, vmread(VMX_CONTROL_ENTRY_INTERRUPTION_INFO));
