...
const register_t timeoutMessage[] = {
    [seL4_TimeoutFaultReply_FaultIP] = FaultInstruction,
    [seL4_TimeoutFaultReply_SP] = SP,
    [seL4_TimeoutFaultReply_CPSR] = CPSR,
    [seL4_TimeoutFaultReply_R0]  = R0,
    [seL4_TimeoutFaultReply_R1]  = R1,
    [seL4_TimeoutFaultReply_R8]  = R8,
    [seL4_TimeoutFaultReply_R9]  = R9,
    [seL4_TimeoutFaultReply_R10] = R10,
    [seL4_TimeoutFaultReply_R11] = R11,
    [seL4_TimeoutFaultReply_R12] = R12,
    [seL4_TimeoutFaultReply_R2]  = R2,
    [seL4_TimeoutFaultReply_R3]  = R3,
    [seL4_TimeoutFaultReply_R4]  = R4,
    [seL4_TimeoutFaultReply_R5]  = R5,
    [seL4_TimeoutFaultReply_R6]  = R6,
    [seL4_TimeoutFaultReply_R7]  = R7,
    [seL4_TimeoutFaultReply_R14] = R14
};
