...
function(declare_default_headers)
    cmake_parse_arguments(
        ...
        CONFIGURE
        ""
        "TIMER_FREQUENCY;MAX_IRQ;NUM_PPI;PLIC_MAX_NUM_INT;INTERRUPT_CONTROLLER;TIMER;SMMU;SMMU_SIZE;SMMU_CB;CLK_SHIFT;CLK_MAGIC;KERNEL_WCET;TIMER_PRECISION"
        ""
    )
    ...
    set(CONFIGURE_SMMU_SIZE "${CONFIGURE_SMMU_SIZE}" CACHE INTERNAL "")
    set(CONFIGURE_SMMU_CB "${CONFIGURE_SMMU_CB}" CACHE INTERNAL "")
