...
static inline void arm_sys_reply(seL4_Word sys, seL4_Word info_arg, seL4_Register mr0, seL4_Register mr1,
                                 seL4_Register mr2,
                                 seL4_Register mr3)
{
    register seL4_Word info asm("x1") = info_arg;
...
static inline void arm_sys_recv(seL4_Word sys, seL4_Word src, seL4_Word *out_badge, seL4_Word *out_info,
                                seL4_Register *out_mr0, seL4_Register *out_mr1, seL4_Register *out_mr2, seL4_Register *out_mr3,
