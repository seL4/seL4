...
def init_arch_types(wordsize, args, enable_cheri):
    ...
    arch_types = {
        ...
        "riscv32": [
            ...
            StructType("seL4_UserContext", wordsize * 32 * (2 if enable_cheri else 1), wordsize, is_cheri_cap=enable_cheri),
        ],
        "riscv64": [
            Type("seL4_RISCV_VMAttributes", wordsize, wordsize),
            CapType("seL4_RISCV_Page", wordsize),
...
def main():
    ...
    # Generate the stubs.
    generate_stub_file(args.arch, args.files, args.output,
                       args.buffer, args.mcs, args.cheri_arch, args)
