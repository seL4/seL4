...
static inline void riscv_sys_send(seL4_Word sys, seL4_Word dest, seL4_Word info_arg, seL4_Register mr0,
                                  seL4_Register mr1,
...
static inline void riscv_sys_reply(seL4_Word sys, seL4_Word info_arg, seL4_Register mr0, seL4_Register mr1,
                                   seL4_Register mr2,
                                   seL4_Register mr3)
{
    register seL4_Word info asm("a1") = info_arg;
