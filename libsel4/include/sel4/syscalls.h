 ...
 *
 * @xmlonly
 * See <autoref label="sec:sys_nbsendrecv"/>
 * @endxmlonly
 *
 * @param[in] dest The capability to be invoked.
 * @param[in] msgInfo The messageinfo structure for the IPC.
 ...
 *
 * @xmlonly
 * See <autoref label="sec:sys_nbsendwait"/>
 * @endxmlonly
 *
 * @param[in] dest The capability to be invoked.
 * @param[in] msgInfo The messageinfo structure for the IPC.
 ...
 *
 * @xmlonly
 * See the description of <nameref name="seL4_Wait"/> in <autoref label="sec:sys_wait"/>.
 * @endxmlonly
 *
 * @param[in] src The capability to be invoked.
 * @param[out] sender The address to write sender information to.
 ...
 *
 * @xmlonly
 * See the description of <nameref name="seL4_NBWait"/> in <autoref label="sec:sys_nbwait"/>.
 * @endxmlonly
 *
 * @param[in] src The capability to be invoked.
 * @param[out] sender The address to write sender information to.
