...
#define TIMER_CLOCK_HZ		99998999llu
...
const p_region_t BOOT_RODATA dev_p_regs[] = {
  ...
  { /* .start = */ TTC0_PADDR              , /* .end = */ TTC0_PADDR               + ( 1 << 12)},
  { /* .start = */ TTC1_PADDR              , /* .end = */ TTC1_PADDR               + ( 1 << 12)},
  { /* .start = */ TTC2_PADDR              , /* .end = */ TTC2_PADDR               + ( 1 << 12)},
  { /* .start = */ TTC3_PADDR              , /* .end = */ TTC3_PADDR               + ( 1 << 12)},
