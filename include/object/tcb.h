...
static inline unsigned int setMR(tcb_t *receiver, rword_t *receiveIPCBuffer,
                                 unsigned int offset, rword_t reg)
{
...
void setExtraBadge(void *bufferPtr, word_t badge, word_t i);
