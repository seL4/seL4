...
-- TODO look at shrinking caps and mdb so the combined size is still a power of two
...
-- TODO fauls can maybe be bit packed back down to 8 bytes
-- Fault: size = 16 bytes
block null_fault {
    padding 64
...
block unknown_syscall {
    -- TODO can this be left at 32 bits ?
...
-- TODO re-examine fastpath packing optimizations
