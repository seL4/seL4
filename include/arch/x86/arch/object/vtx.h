...
#ifndef __PLAT_MACHINE_INTEL_VTX_H
#define __PLAT_MACHINE_INTEL_VTX_H
...
exception_t handleVmexit(void) VISIBLE;
exception_t handleVmEntryFail(void) VISIBLE;
void finishVmexitSaving(void) VISIBLE;
void restoreVMCS(void) VISIBLE;
