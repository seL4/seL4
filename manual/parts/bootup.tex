...
\\
      ...
      0xb & \texttt{seL4\_CapInitThreadSchedContext}   & initial thread's scheduling scontext (see\autoref{sec:sched})\\
      0xc & \texttt{seL4\_CapSchedControl}        & global scheduling cap for managing CPU time (see \autoref{sec:sched}\\
      \bottomrule
    \end{tabularx}
  \end{center}
\end{table}
