...
\item[\apifunc{seL4\_CNode\_SwapCaller}{cnode_swapcaller}] swaps a
  kernel-generated reply capability of the current thread from the
  special \obj{TCB} slot it was created in, with the designated CSpace
  slot. 
\item[\apifunc{seL4\_CNode\_SwapTCBCaller}{cnode_swaptcbcaller}] swaps a
