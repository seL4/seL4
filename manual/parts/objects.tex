...
\begin{description}
    ...
    \item[\apifunc{seL4\_NBSendRecv}{sel4_nbsendrecv}] combines a \apifunc{seL4\_NBSend}{sel4_nbsend} with a \apifunc{seL4\_Recv}{sel4_recv}, and can be called on two different objects (notification objects or endpoints).
    Regardless of the success of the non-blocking send, the receive operation will continue. 
