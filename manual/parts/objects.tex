...
\begin{description}
    ...
    \item[\apifunc{seL4\_Poll}{sel4_poll}] is used by a thread to check for
    messages waiting to be sent through an endpoint without blocking on
    that endpoint. This system call works only on asynchronous endpoint
