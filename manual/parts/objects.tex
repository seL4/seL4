...
\BEGCHECK
    ...
    there a sender and a receiver rendezvous at the endpoint, and the
    ...
    \item[\obj{Notification} Objects] (see \autoref{ch:notifications})
      ...
      is a word-size array of binary semaphores. Operations
      are \emph{signalling} a non-empty subset in a single operation,
