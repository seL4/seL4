...
\begin{description}
    \item[\apifunc{seL4\_ARM\_PageDirectory\_Clean\_Data}{aarch32_pd_clean}]
    \item[\apifunc{seL4\_ARM\_PageDirectory\_Invalidate\_Data}{aarch32_pd_invalidate}]
    \item[\apifunc{seL4\_ARM\_PageDirectory\_CleanInvalidate\_Data}{aarch32_pd_clean_invalidate}]
    \item[\apifunc{seL4\_ARM\_PageDirectory\_Unify\_Instruction}{aarch32_pd_unify_instruction}]

    \item[\apifunc{seL4\_ARM\_PageGlobalDirectory\_Clean\_Data}{aarch64_pgd_clean}]
    \item[\apifunc{seL4\_ARM\_PageGlobalDirectory\_Invalidate\_Data}{aarch64_pgd_invalidate}]
    \item[\apifunc{seL4\_ARM\_PageGlobalDirectory\_CleanInvalidate\_Data}{aarch64_pgd_clean_invalidate}]
    \item[\apifunc{seL4\_ARM\_PageGlobalDirectory\_Unify\_Instruction}{aarch64_pgd_unify_instruction}]
\end{description}
