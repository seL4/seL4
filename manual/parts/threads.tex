...
seL4 uses a preemptive, tickless, round-robin scheduler with 256 priority levels (0 --- 255).
...
A thread's timeslice is determined by its scheduling context, which can be adjusted with 
\apifunc{seL4\_SchedControl\_Configure}{schedcontrol_configure}.
