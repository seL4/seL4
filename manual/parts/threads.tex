...
\apifunc{seL4\_SchedControl\_Configure}{schedcontrol_configure}, and is expressed as a tuple of 
...
The system call \apifunc{seL4\_Yield} can be used to sacrifice any remaining budget and block until the budget is replenished.
