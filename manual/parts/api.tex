...
\newcommand{\schedcontextcapdesc}{Capability to the scheduling context to populate with parameters.}
\newcommand{\budgetdesc}{Timeslice in ticks, when the budget expires the thread will be preempted.}
...
\newcommand{\threadcombinedpriodesc}{A \texttt{seL4\_Prio\_t} structure as described in \autoref{sec:prio}.}
