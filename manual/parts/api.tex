...
\setword{}{common_errors} This section lists common error codes. The same field may also result in specific errors for an invocation, which are described in the error codes of that invocation.
