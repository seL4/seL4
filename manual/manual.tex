...
\begin{document}
  ...
  \copyright~{\commityear} Open Kernel Labs, Inc.\\

  \textsc{All rights reserved}. This document is made available under
  the terms of the Open Kernel Labs, Inc.\ \textsc{Non-Commercial
    License Agreement}. A copy of the license is available in the
