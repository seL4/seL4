...
\ifDraft
  ...
  \newcommand{\BEGCHECK}{\par\noindent\rule{\linewidth}{2pt}\\\Comment{BEGIN CHECK}\par}
  \newcommand{\ENDCHECK}{\par\noindent\Comment{END CHECK}\\\noindent\rule{\linewidth}{2pt}\par}
  \date{}
\else
  \newcommand{\Comment}[1]{\relax}
  \newcommand{\FIXME}[1]{\relax}
  \newcommand{\BEGCHECK}{\relax}
  \newcommand{\ENDCHECK}{\relax
  \date{}
\fi 
